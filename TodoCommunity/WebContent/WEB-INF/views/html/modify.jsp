        ...
        <div class="post">
            <dl>
                <div class="post-detail">
                    ...
                    <dd>
                        <input type="text" id="title" placeholder="제목을 입력해주세요." maxlength="500" value="${post.contentSubject}">
                ...
                <div class="post-detail">
                    ...
                    <dd>
                        <select id="category">
                        	<option type="${post.cateIndex}">${post.cateName}</option>
                        </select>
...
<script>
    $('#summernote').summernote('code', '<c:out value="${post.contentContext}" escapeXml="false"/>');
